...
**Текущая версия: 2.3** — [clickrax.exe](https://github.com/clickrax/clickrax/raw/main/release/v2.3/clickrax.exe) · [clickrax-cli.exe](https://github.com/clickrax/clickrax/raw/main/release/v2.3/clickrax-cli.exe) · [ZIP](https://github.com/clickrax/clickrax/raw/main/release/v2.3/clickrax-windows-amd64-portable.zip) · [установщик](https://github.com/clickrax/clickrax/raw/main/release/v2.3/clickrax-amd64-installer.exe) · [папка release/v2.3](https://github.com/clickrax/clickrax/tree/main/release/v2.3)

> **Скачивание exe:** файлы лежат в папке **[release/v2.3/](https://github.com/clickrax/clickrax/tree/main/release/v2.3)** в репозитории. Перед загрузкой на GitHub запустите `.\scripts\prepare-github.ps1` — скрипт соберёт exe и положит их туда (см. [docs/release-v2.3.ru.md](docs/release-v2.3.ru.md)).
...
- [Release v2.3 — exe и проверка ссылок](docs/release-v2.3.ru.md)
...
Первые релизы на GitHub — **без code signing** (exe из Actions/Releases). Подпись планируется позже, см. [docs/code-signing-policy.md](docs/code-signing-policy.md).

---

## Краткое описание для GitHub (поле About)
...
**Website (optional):** https://github.com/clickrax/clickrax

**Topics:** `windows` `backup` `proxmox-backup-server` `pbs` `proxmox-backup-client` `gui` `incremental-backup` `vss` `golang` `wails` `desktop-app` `multilingual`

**Как выложить на GitHub:** пошаговая инструкция — [docs/github-publish.ru.md](docs/github-publish.ru.md)
